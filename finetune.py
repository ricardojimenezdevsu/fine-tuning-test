...
# resp = file_upload('dataset.jsonl')
# print(resp['id'])
# finetune_model(resp['id'], 'generate_questions_from_context', 'curie')
finetune_list()

# openai.FineTune.cancel("ft-7N64eY3l0eYHNG6ucetKsZKP")
# finetune_events("ft-jKPCiaiONcfQtHa5JCgqAsYM")
